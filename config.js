...
class EnterpriseConfigurationManager {
    ...
    constructPrimaryConfigurationSchema() {
        return {
             ...
             */
            lavalink: {
                host: EnvironmentVariableProcessor.LAVALINK_HOST || "104.167.222.158", 
                port: EnvironmentVariableProcessor.LAVALINK_PORT || 6774,       
                password: EnvironmentVariableProcessor.LAVALINK_PASSWORD || "Ares", 
            ...
            bot: {
                ...
                ownerIds: ["733679432069546054"],      // 👈 ADD YOUR DISCORD ID HERE
                embedColor: 0x5865F2,               // 👈 Bot embed color (hex)
                supportServer: "https://discord.gg/u9TN448z",    // 👈 Your support server link
                defaultStatus: "🎵 Ready for a fucking music broo!"         // 👈 Bot status message
            },
